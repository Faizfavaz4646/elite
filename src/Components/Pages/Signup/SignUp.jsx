...
function SignUp() {
  ...
  const handleSubmit = async (values) => {
    try {
      ...
      // If not, create new user object with additional fields
      const newUser = {
        name: values.name,
        email: values.email,
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-100 px-4">
      <div className="w-full max-w-md bg-white rounded-2xl border-0 border-black shadow-lg shadow-yellow-400 p-6">
            ...
            <Form className="space-y-4">
              <div>
                ...
                <Field
                  type="text"
                  name="name"
                  className="w-full mt-1 p-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-yellow-400"
                />
